...
async function getQuiz(courseSlug: string, quizSlug: string) {
  try {
...
export default async function QuizPage({
  ...
  if (!canAccess) {
    redirect(`/login?callbackUrl=/courses/${slug}/quizzes/${quizSlug}`);
  }
  ...
  const currentIndex = allItems.findIndex((item) => item.id === quiz.id && item.type === 'quiz');
