  ...
  const submissions = [
    {
      ...
      content: 'I analyzed a property in downtown area. The property is a 3-bedroom, 2-bathroom single-family home with 1,500 sqft. Comparable properties in the area range from $350k-$400k. Based on the condition and location, I recommend listing at $375k.',
      score: 95,
    ...
    },
    {
      agentId: agents[1].id,
      assignmentId: assignment1.id,
      content: 'Property analysis completed for a 2-bedroom condo. The unit is well-maintained and located in a desirable neighborhood. Comparable sales show prices between $200k-$250k. Recommended listing price: $225k.',
      score: 88,
      submittedAt: new Date(),
    },
    {
      agentId: agents[2].id,
      assignmentId: assignment1.id,
      content: 'I researched a commercial property - a retail space of 2,000 sqft. The location is prime with high foot traffic. Similar properties in the area are priced at $500k-$600k. Suggested listing: $550k.',
      score: 92,
      submittedAt: new Date(),
    },
    {
      agentId: agents[3].id,
      assignmentId: assignment1.id,
      content: 'Analyzed a townhouse property with 4 bedrooms. The property needs some updates but has good potential. Market analysis shows comparable properties at $280k-$320k. Recommend listing at $300k.',
      score: 85,
      submittedAt: new Date(),
    },
    {
      agentId: agents[4].id,
      assignmentId: assignment1.id,
      content: 'Completed property analysis for a luxury single-family home. The property features 5 bedrooms, 3 bathrooms, and premium finishes. Comparable luxury homes in the area range from $800k-$1M. Recommended listing price: $900k.',
      score: 90,
      submittedAt: new Date(),
    },
  ];
